...
class LetterboxdToTraktSync:
    def __init__(self):
        ...
        # Initialize logging
        logging.info("Starting Letterboxd to Trakt sync")
    ...
    def run(self):
        ...
        if not movies:
            logging.error("Failed to get Letterboxd data")
            return False
    ...
    def get_letterboxd_data(self):
        ...
        try:
            ...
            for entry in feed.entries:
                ...
                watched_date = entry.letterboxd_watcheddate if hasattr(entry, 'letterboxd_watcheddate') else None
                ...
                if watched_date:
                    # Add time component (noon UTC) to ensure the date stays the same across time zones
                    watched_at = f"{watched_date}T12:00:00.000Z"
                else:
                    watched_at = None
