# DEPRECIATED - NEW VERSION OF SCRIPT ALLOWS YOU TO SPECIFY A DATE TO SYNC FROM. USE THAT WITH A SCHEDULER TO ACHIEVE THE SAME AS THIS SCRIPT. LEAVING THIS UP AS REFERENCE!
import requests
import json
import os
import time
